...
int main(int argc, char* argv[])
{
	...
	cout  << "\n================================================================================"
			<< "\nUSO:"
			<< "\n./cgnuplot.teste.min"
			<< "\nVai usar o terminal padrão de seu sistema que é: " << CGnuplot::Terminal()
			<< "\nou"
			<< "\n./cgnuplot.teste.min terminalType"
			<< "\nSendo terminalType uma das opções abaixo:"
			<< "\nx11"
			<< "\nqt"
			<< "\nwxt"
			<< "\naqua"
			<< "\n..."
			<< "\n(estes sistemas de janela devem estar previamente instalados)"
            << "\n================================================================================" << endl;
    if( argc > 1 ) {
        string terminalType = CGnuplot::Terminal();
        cout << "\nterminalType tinha o valor -> "<< terminalType << endl;
        terminalType = argv[1];
        cout << "\natualizando terminalType para -> "<< terminalType << endl;
